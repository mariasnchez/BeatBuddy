...
def header():
    return """
        <div id="header" class="d-flex justify-content-end align-items-center pe-2 pt-2">
            <div class="link-div fs-4 me-3" style="font-family: 'DM Sans', 'Source Sans Pro'", sans-serif;"><a class="header-link" href="https://prueba-app-2-alsnfdpxrmwiwyucrmdf8r.streamlit.app/Asistente_Musical" target="_self">Asistente Musical</a></div>
            <div class="link-div fs-4 me-3" style="font-family: 'DM Sans', 'Source Sans Pro'", sans-serif;"><a class="header-link" href="https://prueba-app-2-alsnfdpxrmwiwyucrmdf8r.streamlit.app/Reconocimiento_Facial" target="_self">Reconocimiento facial</a></div>
            <div class="link-div fs-4 me-3" style="font-family: 'DM Sans', 'Source Sans Pro'", sans-serif;"><a class="header-link" href="https://prueba-app-2-alsnfdpxrmwiwyucrmdf8r.streamlit.app/Chatbot" target="_self">Chatbot</a></div>
            <div class="link-div fs-4" style="font-family: 'DM Sans', 'Source Sans Pro'", sans-serif;"><a class="header-link" href="https://prueba-app-2-alsnfdpxrmwiwyucrmdf8r.streamlit.app/Sobre_Nosotros" target="_self">Sobre nosotros</a></div>
        </div>
    """
...
def header2():
    return """
        <div id="header" class="d-flex justify-content-end align-items-center pe-2 pt-2">
            <div class="logo">
                <a href="https://prueba-app-2-alsnfdpxrmwiwyucrmdf8r.streamlit.app" target="_self"><img src="https://prueba-app-2-alsnfdpxrmwiwyucrmdf8r.streamlit.app:443/~/+/media/cdf0488c738115d7f79bedc0dbba33fcddaf432f3e57a3d5eea75553.png" alt="Logo"></a>
            </div>
            <div class="link-div fs-4 me-3" style="font-family: 'DM Sans', 'Source Sans Pro'", sans-serif;"><a class="header-link" href="https://prueba-app-2-alsnfdpxrmwiwyucrmdf8r.streamlit.app/Asistente_Musical" target="_self">Asistente Musical</a></div>
            <div class="link-div fs-4 me-3" style="font-family: 'DM Sans', 'Source Sans Pro'", sans-serif;"><a class="header-link" href="https://prueba-app-2-alsnfdpxrmwiwyucrmdf8r.streamlit.app/Reconocimiento_Facial" target="_self">Reconocimiento facial</a></div>
            <div class="link-div fs-4 me-3" style="font-family: 'DM Sans', 'Source Sans Pro'", sans-serif;"><a class="header-link" href="https://prueba-app-2-alsnfdpxrmwiwyucrmdf8r.streamlit.app/Chatbot" target="_self">Chatbot</a></div>
